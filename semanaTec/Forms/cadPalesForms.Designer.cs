namespace semanaTec.Forms
{
    partial class cadPalesForms
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.groupBox1.Controls.Add(this.titulacaoLbl);
            this.groupBox1.Controls.Add(this.miniCTxt);
            this.groupBox1.Controls.Add(this.emailTxt);
            this.groupBox1.Controls.Add(this.miniCLbl);
            this.groupBox1.Controls.Add(this.emailLbl);
            this.groupBox1.Controls.Add(this.telMsk);
            this.groupBox1.Controls.Add(this.titulacaoCB);
            this.groupBox1.Controls.Add(this.cidadeLbl);
            this.groupBox1.Controls.Add(this.cidadeTxt);
            this.groupBox1.Controls.Add(this.telefoneLbl);
            ...
            this.groupBox1.Text = "Informações do palestrante";
            // 
            // cadPalesForms
            // 
